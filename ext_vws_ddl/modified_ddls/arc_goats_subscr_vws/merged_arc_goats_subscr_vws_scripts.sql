CREATE OR REPLACE VIEW mods_bi.arc_goats_subscr_vws.bzfc_taxo_bio_collection_curr AS
SELECT
taxo_vers_key,
taxo_typ_key,
taxo_typ,
...
GRANT ALL ON TABLE mods_bi.arc_goats_subscr_vws.bzfc_taxo_bio_collection_curr TO role ds_mods_writer;
GRANT SELECT ON TABLE mods_bi.arc_goats_subscr_vws.bzfc_taxo_bio_collection_curr TO role ds_mods_reader_vt;

CREATE OR REPLACE VIEW mods_bi.arc_goats_subscr_vws.bzfc_taxo_humanitarian_curr AS
SELECT
taxo_vers_key,
taxo_typ_key,
taxo_typ,
...
AND valid_end_dt::DATE >= CURRENT_TIMESTAMP(0)::DATE
WITH NO SCHEMA BINDING;
GRANT ALL ON TABLE mods_bi.arc_goats_subscr_vws.bzfc_taxo_humanitarian_curr TO role ds_mods_writer;
GRANT SELECT ON TABLE mods_bi.arc_goats_subscr_vws.bzfc_taxo_humanitarian_curr TO role ds_mods_reader_vt;

CREATE OR REPLACE VIEW mods_bi.arc_goats_subscr_vws.bzfc_taxo_subscr_gplg AS
SELECT DISTINCT
...
FROM eda.arc_goats_vws.bzfc_taxo_denorm_curr AS a
INNER JOIN eda.arc_goats_vws.bz_taxo_vers_pub AS vers
