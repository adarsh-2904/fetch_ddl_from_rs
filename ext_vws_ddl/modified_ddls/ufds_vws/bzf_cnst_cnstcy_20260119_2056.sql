CREATE OR REPLACE VIEW mods_bi.ufds_vws.bzf_cnst_cnstcy AS
SELECT
cnst_mstr_id,
one_k_ind,
five_k_ind,
...
volntr_ind,
dw_trans_ts
FROM cdigms_rep.ufds_tbls.bzf_cnst_cnstcy
WITH NO SCHEMA BINDING;
GRANT ALL ON TABLE mods_bi.ufds_vws.bzf_cnst_cnstcy TO role ds_mods_writer;
GRANT SELECT ON TABLE mods_bi.ufds_vws.bzf_cnst_cnstcy TO role ds_mods_reader_vt;
