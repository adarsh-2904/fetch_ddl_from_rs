CREATE TABLE mktg_ops_tbls.adb_nmsbroadlogmsg (
    ...
    sfirstaddress character varying(230) ENCODE lzo,
    sfirsttext character varying(614) ENCODE lzo,
    smd5 character varying(38) ENCODE lzo,
    stext character varying(614) ENCODE lzo,
