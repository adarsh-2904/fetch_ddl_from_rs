CREATE TABLE mktg_ops_tbls.cnst_cdi_s_f_p_fr_email (
    ...
    cnst_line_1_addr character varying(400) ENCODE lzo,
    cnst_line_2_addr character varying(400) ENCODE lzo,
    cnst_city_nm character varying(400) ENCODE lzo,
    cnst_st_cd character(10) ENCODE lzo,
    cnst_zip_5_cd character(15) ENCODE lzo,
    cnst_zip_4_cd character(25) ENCODE lzo,
    ...
    cnst_email_assessmnt_ctg character varying(128) ENCODE lzo,
