CREATE OR REPLACE VIEW mktg_ops_vws.bzfc_fsa_cnst_org_cntct_prefc AS 
-- mktg_ops_vws.bzfc_fsa_cnst_org_cntct_prefc source

/* **************************mktg_ops_vws.bzfc_fsa_cnst_org_cntct_prefc sql************************** */
...
------------------------------------------------------------------------------------------------------------------------------------ */
mktg_ops_vws.bzfc_fsa_cnst_org_cntct_prefc AS
SELECT
a.cnst_mstr_id,
a.bzd_cnst_fsa_key,
a.bzd_acct_fsa_key,
...
FROM 
eda.arc_mdm_vws.bzl_cnst_mstr_fsa a JOIN 
ddcoe_vws.bzf_cnst_fsa_cntct_prefc b ON a.bzd_cnst_fsa_key = b.cnst_fsa_key
where  a.cnst_typ_cd = 'OR'
