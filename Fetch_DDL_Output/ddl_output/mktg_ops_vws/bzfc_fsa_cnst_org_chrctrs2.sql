CREATE OR REPLACE VIEW mktg_ops_vws.bzfc_fsa_cnst_org_chrctrs2 AS 
-- mktg_ops_vws.bzfc_fsa_cnst_org_chrctrs2 source

create or REPLACE VIEW 
/* **************************mktg_ops_vws.bzfc_fsa_cnst_org_chrctrs2 sql************************** */
/* ---------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------------------ */
mktg_ops_vws.bzfc_fsa_cnst_org_chrctrs2 AS 
