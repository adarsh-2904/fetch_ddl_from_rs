CREATE TABLE mktg_ops_tbls.aprm_wb_apnd_treatmnts (
    ...
    actvty_specific character varying(765) ENCODE lzo COLLATE case_insensitive,
    channel character varying(255) ENCODE lzo COLLATE case_insensitive,
    currency_cd character varying(255) ENCODE lzo COLLATE case_insensitive,
    ...
    trmt_cd character varying(75) ENCODE lzo COLLATE case_insensitive,
    trmt_id integer ENCODE az64,
    typ character varying(255) ENCODE lzo COLLATE case_insensitive,
