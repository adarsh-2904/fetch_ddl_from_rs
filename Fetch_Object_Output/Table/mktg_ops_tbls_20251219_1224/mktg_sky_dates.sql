CREATE TABLE mktg_ops_tbls.mktg_sky_dates (
    ...
    calendar_key	calendar_dt	sky_typ	disastr1_nm	disastr1_typ	disastr2_nm	disastr3_nm	disastr4_nm	disastr5_nm	dw_trans_ts	row_stat_ character varying(128) ENCODE lzo COLLATE case_sensitive
)
DISTSTYLE AUTO;