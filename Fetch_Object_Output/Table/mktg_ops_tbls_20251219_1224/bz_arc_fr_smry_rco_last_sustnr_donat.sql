CREATE TABLE mktg_ops_tbls.bz_arc_fr_smry_rco_last_sustnr_donat (
    ...
    rco_subscription_id character varying(255) NOT NULL ENCODE lzo COLLATE case_sensitive,
    subscription_stat character varying(40) ENCODE lzo COLLATE case_sensitive,
    online_channel_cd character varying(5) ENCODE lzo COLLATE case_sensitive,
    nk_public_cd character varying(255) ENCODE lzo COLLATE case_sensitive,
    ocu_email character varying(255) ENCODE lzo COLLATE case_sensitive,
