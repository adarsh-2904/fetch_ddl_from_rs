CREATE TABLE mktg_ops_tbls.dim_phone_call_dspstn (
    ...
    dspstn_dsc character varying(50) ENCODE zstd COLLATE case_sensitive,
    dspstn_ctg_cd character varying(1) ENCODE zstd COLLATE case_sensitive,
    dspstn_ctg_dsc character varying(40) ENCODE zstd COLLATE case_sensitive,
