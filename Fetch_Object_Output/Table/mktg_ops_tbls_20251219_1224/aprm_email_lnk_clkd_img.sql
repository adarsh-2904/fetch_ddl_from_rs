CREATE TABLE mktg_ops_tbls.aprm_email_lnk_clkd_img (
    ...
    link_url character varying(6252) ENCODE lzo COLLATE case_insensitive,
    is_first_click integer ENCODE az64,
    browser character varying(225) ENCODE lzo COLLATE case_insensitive,
    operating_system character varying(225) ENCODE lzo COLLATE case_insensitive,
    mobile_device character varying(225) ENCODE lzo COLLATE case_insensitive,
