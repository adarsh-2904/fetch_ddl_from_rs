CREATE TABLE mktg_ops_tbls.dim_treatmnt (
    ...
    treatmnt_cd character varying(255) ENCODE zstd COLLATE case_sensitive,
    report_cell_cd_id character varying(255) ENCODE zstd COLLATE case_sensitive,
    active_ind smallint ENCODE zstd,
    treatmnt_dsc character varying(255) ENCODE zstd COLLATE case_sensitive,
