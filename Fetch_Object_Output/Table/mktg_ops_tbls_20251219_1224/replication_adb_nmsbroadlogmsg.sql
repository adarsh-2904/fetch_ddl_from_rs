CREATE TABLE mktg_ops_tbls.replication_adb_nmsbroadlogmsg (
    ...
    sfirstaddress character varying(192) ENCODE lzo COLLATE case_sensitive,
    sfirsttext character varying(512) ENCODE lzo COLLATE case_sensitive,
    smd5 character varying(32) ENCODE lzo COLLATE case_sensitive,
    stext character varying(512) ENCODE lzo COLLATE case_sensitive,
