CREATE TABLE mktg_ops_tbls.dim_phone_campgn_bkp (
    ...
    campgn_cd character varying(10) ENCODE lzo COLLATE case_sensitive distkey,
    campgn_typ character varying(30) ENCODE lzo COLLATE case_sensitive,
    campgn_dsc character varying(100) ENCODE lzo COLLATE case_sensitive,
    program_typ character varying(30) ENCODE lzo COLLATE case_sensitive,
    fyr integer ENCODE raw,
    qtr smallint ENCODE raw,
    start_dt date ENCODE raw,
    end_dt date ENCODE az64,
    billing_typ character varying(20) ENCODE lzo COLLATE case_sensitive,
