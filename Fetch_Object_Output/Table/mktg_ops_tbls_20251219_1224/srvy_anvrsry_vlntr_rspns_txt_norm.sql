CREATE TABLE mktg_ops_tbls.srvy_anvrsry_vlntr_rspns_txt_norm (
    rspns_id integer NOT NULL ENCODE az64 distkey,
    ...
    rspns_txt character varying(10000) ENCODE lzo COLLATE case_insensitive,
