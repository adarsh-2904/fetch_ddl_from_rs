CREATE TABLE mktg_ops_tbls.aprm_email_bncd_b401072026 (
    ...
    bncd_ctgy_ttl character varying(75) ENCODE lzo COLLATE case_insensitive,
    bncd_subctgy_ttl character varying(2048) ENCODE lzo COLLATE case_insensitive,
