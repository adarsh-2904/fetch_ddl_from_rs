CREATE TABLE mktg_ops_tbls.fresh_address_email_append (
    ...
    match_typ_cd character varying(5) ENCODE lzo COLLATE case_sensitive,
    cnst_email character varying(200) ENCODE lzo COLLATE case_sensitive,
    list_nm character varying(30) ENCODE lzo COLLATE case_sensitive,
    ...
    row_stat_cd character varying(4) ENCODE lzo COLLATE case_sensitive,
