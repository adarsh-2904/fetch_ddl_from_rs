CREATE TABLE mktg_ops_tbls.aprm_wb_apnd_rmv_frm_lst (
    ...
    opt_out_form_ttl character varying(75) ENCODE lzo COLLATE case_insensitive,
    opt_out_rsn character varying(100) ENCODE lzo COLLATE case_insensitive,
    opt_out_typ character varying(75) ENCODE lzo COLLATE case_insensitive,
    subscriber_key character varying(36) ENCODE lzo COLLATE case_insensitive,
    typ_id character varying(765) ENCODE lzo COLLATE case_insensitive,
