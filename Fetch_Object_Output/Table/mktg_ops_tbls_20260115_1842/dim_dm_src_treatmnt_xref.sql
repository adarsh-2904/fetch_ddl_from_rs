CREATE TABLE mktg_ops_tbls.dim_dm_src_treatmnt_xref (
    ...
    src_cd character varying(14) ENCODE lzo COLLATE case_sensitive distkey,
    pg_src_cd character varying(14) ENCODE lzo COLLATE case_sensitive,
    nk_treatmnt_id integer ENCODE raw,
    treatmnt_cd character varying(255) ENCODE lzo COLLATE case_sensitive,
    treatmnt_dsc character varying(255) ENCODE lzo COLLATE case_sensitive,
