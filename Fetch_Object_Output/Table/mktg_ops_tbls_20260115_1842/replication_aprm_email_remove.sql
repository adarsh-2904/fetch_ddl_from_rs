CREATE TABLE mktg_ops_tbls.replication_aprm_email_remove (
    ...
    optout_form_ttl character varying(75) ENCODE lzo COLLATE case_insensitive,
    actvty_id integer ENCODE az64,
    actvty_ttl character varying(75) ENCODE lzo COLLATE case_insensitive,
    actvty_typ_id integer ENCODE az64,
    actvty_typ_ttl character varying(75) ENCODE lzo COLLATE case_insensitive,
