CREATE TABLE mktg_ops_tbls.arc_vms_txn (
    ...
    vol_geo_zip_cd character varying(10) ENCODE lzo COLLATE case_sensitive,
    disaster_assignment_flg character(1) ENCODE lzo COLLATE case_sensitive,
    lob_nm character varying(50) ENCODE lzo COLLATE case_sensitive,
