CREATE TABLE mktg_ops_tbls.adb_nmsaddress (
    ...
    ideliveryid integer NOT NULL ENCODE az64 distkey,
    iquarantinereason smallint NOT NULL ENCODE az64,
    istatus smallint NOT NULL ENCODE az64,
    itype smallint NOT NULL ENCODE az64,
    mquarantinetext character varying(255) ENCODE lzo COLLATE case_sensitive,
    saddress character varying(192) ENCODE lzo COLLATE case_sensitive,
