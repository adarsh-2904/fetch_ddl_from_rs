CREATE TABLE mktg_ops_tbls.aprm_wb_apnd_eml_trckng_bkp (
    ...
    browser character varying(75) ENCODE lzo COLLATE case_insensitive,
    ...
    first_click character varying(765) ENCODE lzo COLLATE case_insensitive,
    hist_rec_ts timestamp without time zone ENCODE az64,
    hist_rec_id integer ENCODE az64,
    interaction_id integer ENCODE az64,
    link_url character varying(2084) ENCODE lzo COLLATE case_insensitive,
    mbl_dvc character varying(75) ENCODE lzo COLLATE case_insensitive,
    op_sys character varying(75) ENCODE lzo COLLATE case_insensitive,
    outbnd_id integer ENCODE az64,
    sgmt_id integer ENCODE az64,
    sgmtn_id integer ENCODE az64,
    trk_typ character varying(765) ENCODE lzo COLLATE case_insensitive,
