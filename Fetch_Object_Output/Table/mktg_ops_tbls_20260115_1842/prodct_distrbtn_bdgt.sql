CREATE TABLE mktg_ops_tbls.prodct_distrbtn_bdgt (
    mstr_cust_cd character varying(20) NOT NULL ENCODE lzo COLLATE case_sensitive distkey,
    product_family character varying(20) ENCODE lzo COLLATE case_sensitive,
