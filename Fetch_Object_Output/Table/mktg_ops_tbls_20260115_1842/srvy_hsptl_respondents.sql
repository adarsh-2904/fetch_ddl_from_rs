CREATE TABLE mktg_ops_tbls.srvy_hsptl_respondents (
    respondent_id bigint NOT NULL ENCODE az64,
    sf_contact_id character varying(100) ENCODE lzo COLLATE case_sensitive,
    ...
    respondent_role character varying(256) ENCODE lzo COLLATE case_sensitive,
    hospital_id character varying(20) ENCODE lzo COLLATE case_sensitive,
