CREATE TABLE mktg_ops_tbls.gms_bzfc_donation_rank (
    ...
    nk_gift_id character varying(20) ENCODE lzo COLLATE case_sensitive,
    campgn_src_cd character varying(20) ENCODE lzo COLLATE case_sensitive,
    gift_src_cd character varying(20) ENCODE lzo COLLATE case_sensitive,
