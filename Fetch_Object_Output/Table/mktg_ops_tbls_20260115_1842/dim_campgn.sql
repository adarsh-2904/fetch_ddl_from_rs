CREATE TABLE mktg_ops_tbls.dim_campgn (
    ...
    campgn_cd character varying(64) ENCODE lzo COLLATE case_sensitive,
    campgn_nm character varying(128) ENCODE lzo COLLATE case_sensitive,
    campgn_plan_id integer ENCODE az64,
    campgn_plan_nm character varying(128) ENCODE lzo COLLATE case_sensitive,
    campgn_lob_id integer ENCODE az64,
    campgn_lob_nm character varying(128) ENCODE lzo COLLATE case_sensitive,
    campgn_channel_id integer ENCODE az64,
    campgn_channel_nm character varying(128) ENCODE lzo COLLATE case_sensitive,
    campgn_program_id integer ENCODE az64,
    campgn_program_nm character varying(128) ENCODE lzo COLLATE case_sensitive,
