CREATE TABLE mktg_ops_tbls.adb_arcbitlyreturn (
    ...
    scampaignlabel character varying(128) ENCODE lzo COLLATE case_sensitive,
    scampaignname character varying(64) ENCODE lzo COLLATE case_sensitive,
    sdelnature character varying(64) ENCODE lzo COLLATE case_sensitive,
    sdeliverylabel character varying(128) ENCODE lzo COLLATE case_sensitive,
    sdeliveryname character varying(100) ENCODE lzo COLLATE case_sensitive,
