CREATE TABLE mktg_ops_tbls.adb_arcbitlyreturn_b401072026 (
    ...
    scampaignlabel character varying(128) ENCODE lzo COLLATE case_insensitive,
    scampaignname character varying(64) ENCODE lzo COLLATE case_insensitive,
    sdelnature character varying(64) ENCODE lzo COLLATE case_insensitive,
    sdeliverylabel character varying(128) ENCODE lzo COLLATE case_insensitive,
    sdeliveryname character varying(100) ENCODE lzo COLLATE case_insensitive,
