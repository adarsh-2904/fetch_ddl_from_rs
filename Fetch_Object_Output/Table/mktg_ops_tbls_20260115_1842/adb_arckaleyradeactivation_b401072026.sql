CREATE TABLE mktg_ops_tbls.adb_arckaleyradeactivation_b401072026 (
    ...
    scarrier character varying(255) ENCODE lzo COLLATE case_insensitive,
    sconsecutive_em_del_failed character varying(255) ENCODE lzo COLLATE case_insensitive,
    sconsecutive_sms_del_failed character varying(255) ENCODE lzo COLLATE case_insensitive,
    sdeact_file_record_status character varying(255) ENCODE lzo COLLATE case_insensitive,
    semail_address character varying(255) ENCODE lzo COLLATE case_insensitive,
    smobile_num character varying(255) ENCODE lzo COLLATE case_insensitive,
    snew_mdn character varying(255) ENCODE lzo COLLATE case_insensitive,
    srow_wid character varying(255) ENCODE lzo COLLATE case_insensitive,
